...
proc ::03_serverIrrigation::test {rootDir} {
    ...
    set irriConf(localtechnique,timeMatinStarter)     "30"
    set irriConf(localtechnique,timeApresStarter)     "30"
    set irriConf(localtechnique,timeNuitStarter)     "30"
    ...
    set irriConf(engrais,0,useMatinNormal)     "true"
    set irriConf(engrais,0,useApresNormal)     "true"
    set irriConf(engrais,0,useNuitNormal)     "true"
    set irriConf(engrais,0,useMatinStarter)     "true"
    set irriConf(engrais,0,useApresStarter)     "true"
    set irriConf(engrais,0,useNuitStarter)     "true"
    ...
    set irriConf(engrais,1,useMatinNormal)     "true"
    set irriConf(engrais,1,useApresNormal)     "true"
    set irriConf(engrais,1,useNuitNormal)     "true"
    set irriConf(engrais,1,useMatinStarter)     "true"
    set irriConf(engrais,1,useApresStarter)     "true"
    set irriConf(engrais,1,useNuitStarter)     "true"
    ...
    set irriConf(engrais,2,useMatinNormal)     "true"
    set irriConf(engrais,2,useApresNormal)     "true"
    set irriConf(engrais,2,useNuitNormal)     "true"
    set irriConf(engrais,2,useMatinStarter)     "true"
    set irriConf(engrais,2,useApresStarter)     "true"
    set irriConf(engrais,2,useNuitStarter)     "true"
    ...
    set irriConf(engrais,3,useMatinNormal)     "true"
    set irriConf(engrais,3,useApresNormal)     "true"
    set irriConf(engrais,3,useNuitNormal)     "true"
    set irriConf(engrais,3,useMatinStarter)     "true"
    set irriConf(engrais,3,useApresStarter)     "true"
    set irriConf(engrais,3,useNuitStarter)     "true"
    ...
    set irriConf(plateforme,0,tempsMaxRemp)     "45"
    set irriConf(plateforme,0,tempsMaxRempNuit)     "45"
    set irriConf(plateforme,0,tempsMaxRempApresMidi)     "45"
    set irriConf(plateforme,0,priseDansLT)     "7"
    set irriConf(plateforme,0,priseEau)     "5"
    set irriConf(plateforme,0,activeAutoRemplissage)     "true"
